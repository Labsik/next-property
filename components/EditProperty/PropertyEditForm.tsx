...
import type { PropertyType } from "../Properties/properties.types";
...
const PropertyEditForm = ({ property }: Props) => {
	const updatePropertyById = updateProperty.bind(null, property._id);
	return (
		<PropertyForm property={property} type="edit" action={updatePropertyById} />
